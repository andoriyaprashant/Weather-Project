...
def home(request):
    ...
    url = f'https://api.openweathermap.org/data/2.5/weather?q={city}&appid=99cc07e06f54fae15b64c08f65292e54'
    PARAMS = {'units':'metric'}

    API_KEY =  'AIzaSyC4AWzQrdvjefWO9eU21VwzFQCmFIR2cQI'

    SEARCH_ENGINE_ID = '740fa8a26d1fe4e61'
